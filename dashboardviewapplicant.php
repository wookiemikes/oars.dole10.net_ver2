    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">Applicant View</div>
            </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class=" table">
                                            ...
                                            <tr>
                                                <td colspan="2"><b>Passport No.:</b></td>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <table class=" table">
                                            ...
                                            <tr>
                                                <td colspan="2"><button class="btn-sm btn-info btn btn-block">UPDATE REQUIREMENTS</button></td>
                                            </tr>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="dashboardviewapplicant.php" method="post">
