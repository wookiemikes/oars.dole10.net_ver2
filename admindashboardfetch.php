<?php 
session_start();
//$connect = mysqli_connect("localhost", "root", "d0l310_aep", "d0l310_aep");
...
$query = "SELECT * FROM `aep_user_details` where user_status = 'PENDING' ";
...
function get_all_data($connect){
	$query = "SELECT * FROM aep_user_details";
