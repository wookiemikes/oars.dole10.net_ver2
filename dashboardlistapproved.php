                            ...
                            <a href="dashboardlistapplicant.php">
                                <div class="card border-left-warning shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-sm font-weight-bold text-warning text-uppercase mb-1">AEP LIST (PENDING)</div>
                        ...
                        <div class="col-xl-12 col-lg-10 col-md-8">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">List of Approved Applicants</h6>

                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="approved" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Full Name</th>
                                                    <th>Nationality</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data1() {
                var dataTable = $('#approved').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "columnDefs": [{
                        "orderable": false,
