...
<head>
    ...
    <title>AEP - Dashboard View Approved</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3">AEP VIEWER</div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Welcome, <?php echo $company_email ?></span>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class=" table">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="1"><b>Place of Issuance:</b></td>
                                                <td colspan="2"><?php echo $_SESSION['place_issuance']; ?></td>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <table class=" table">
                                            ...
                                            <tr>
                                                <td cstyle="width: 50%;"><b>Requirements:</b></td>
                                                <td style="width: 50%;"><b><a href="<?php echo $_SESSION['gdrive_link']; ?>" target="_blank">REQUIRMENTS LINK HERE</a></b></td>
                                            ...
                                            <tr>
                                                <td colspan="2"><textarea class="form-control" id="exampleFormControlTextarea1" rows="2" name="remarks1" placeholder="State Here" readonly><?php echo $_SESSION['remarks']; ?></textarea></td>
                                            </tr>

                                            <tr>
                                                <td class="text-center" colspan="2"><button class="btn btn-block btn-danger btn-sm" data-toggle="modal" data-target="#deny">Disable AEP</button></td>
                                            </tr>
                                        </table>
                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle"><b>Disable Applicant?</b></h5>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="dashboardviewapproved.php" method="post">
